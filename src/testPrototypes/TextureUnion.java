 ...
 * @author usero
 */
public class TextureUnion extends SimpleApplication {

    Geometry offBoxMain;
    public Geometry offBox;
    public Texture2D offTex;
    OffScreenUnionProcessor osip;
    OffScreenNodeProcessor osnp;
    ...
    public static void main(String[] args) {
        TextureUnion app = new TextureUnion();
        app.start();
    }
    ...
    public void simpleInitApp() {
        ...
        osip = new OffScreenUnionProcessor();
        offView.addProcessor(osip);
        offView.setOutputFrameBuffer(offBuffer);

        Box boxMesh = new Box(1, 1, 1);
        Material material = new Material(assetManager, "Materials/UnionMaterial.j3md");
    ...
    public void setup(RenderManager rm, AssetManager am, OffScreenNodeProcessor osip_p, int textSize) {
        ...
        Geometry quad = new Geometry("boxUnion", new Box(1, 1, 1));
        ...
        //FrameBuffer offBuffer = new FrameBuffer(textSize, textSize, 1);
        ...
        Box boxMesh = new Box(1, 1, 1);
        material = new Material(am, "Materials/UnionMaterial.j3md");
