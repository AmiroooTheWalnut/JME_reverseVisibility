...
public class SimulatorDebug extends javax.swing.JDialog {
    ...
    public SimulatorDebug(java.awt.Window window, MainFramePanel parent, ModalityType modal) {
        ...
        resetLayerList.setSelectedIndex(myParent.findLayerContains("competitors") + 1);
    ...
    private void initOneLayerCompetitionLavaBasedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_initOneLayerCompetitionLavaBasedActionPerformed
        ...
        if (resetLayerList.getSelectedIndex() == 0) {
            myParent.flowControl.simulateOneLayerCompetingLavaBased(testFacilities, myParent.findLayerContains("traffic"), (int) numCPUSpinner.getValue(), -1, isIterative.isSelected());
        } else {
            myParent.flowControl.simulateOneLayerCompetingLavaBased(testFacilities, myParent.findLayerContains("traffic"), (int) numCPUSpinner.getValue(), resetLayerList.getSelectedIndex() - 1, isIterative.isSelected());
        }
        //REPORTING
    ...
    private void initOneLayerCompetitionFacilityBasedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_initOneLayerCompetitionFacilityBasedActionPerformed
        ...
        //REPORTING
        if (resetLayerList.getSelectedIndex() == 0) {
            myParent.flowControl.simulateOneLayerCompetingFacilityBased(testFacilities, myParent.findLayerContains("traffic"), (int) numCPUSpinner.getValue(), -1, isIterative.isSelected());
        } else {
            myParent.flowControl.simulateOneLayerCompetingFacilityBased(testFacilities, myParent.findLayerContains("traffic"), (int) numCPUSpinner.getValue(), resetLayerList.getSelectedIndex() - 1, isIterative.isSelected());
        }
        //REPORTING
        long endTime = System.nanoTime();
        double elapsed = ((endTime - startTime) / 1000000000);
    ...
    private void initMultiLayerZoneBasedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_initMultiLayerZoneBasedActionPerformed
        ...
        //REPORTING
        if (resetLayerList.getSelectedIndex() == 0) {
            myParent.flowControl.simulateMultiLayerCompetingZoneBased(testZones, myParent.findLayerContains("traffic"), (int) numCPUSpinner.getValue(), -1, isIterative.isSelected());
        } else {
            myParent.flowControl.simulateMultiLayerCompetingZoneBased(testZones, myParent.findLayerContains("traffic"), (int) numCPUSpinner.getValue(), resetLayerList.getSelectedIndex() - 1, isIterative.isSelected());
        }
        //REPORTING
        long endTime = System.nanoTime();
        double elapsed = ((endTime - startTime) / 1000000000);
    ...
    private void initOneLayerNonCompetitionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_initOneLayerNonCompetitionActionPerformed
        ...
        myParent.flowControl.simulateOneLayerNonCompetingSerial(testFacilities, myParent.findLayerContains("traffic"), isIterative.isSelected());
        setLavaLayersList();
        isLavaBased = false;
        isFacilityBased = true;
        isZoneActive = false;
...
//                myApp.refreshApp();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        myParent.flowControl.correctFacilityLava(myParent.findLayerContains("traffic"),(int) numCPUSpinner.getValue());
        if (currentLavaLayers.getSelectedIndex() != -1) {
            currentLavaLayersValueChanged(null);
        }
