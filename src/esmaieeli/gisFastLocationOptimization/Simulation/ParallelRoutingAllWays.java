...
//                    System.out.println("progress: " + (float)(i-startIndex)/(float)(endIndex-startIndex));
                        ...
                        if (myAllData.all_Ways[i].myNodes[j].burntBy != null) {
                            for (int k = 0; k < myAllData.all_Ways[i].myNodes[j].burntBy.length; k++) {
                                if (myAllData.all_Ways[i].myNodes[j].burntBy[k] != null) {
                                    if (myAllData.all_Ways[i].myNodes[j].isConnectedToFacility[k] == false) {
...
//                                            System.out.println("NO PATH!");
                                        ...
                                        for (int m = 0; m < myAllData.all_Ways[i].myNodes[j].burntBy.length; m++) {
                                            myAllData.all_Ways[i].myNodes[j].isConnectedToFacility[m]=true;
                                        }
                                    }
//                                    else{
